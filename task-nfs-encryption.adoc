...
.Ergebnis
Durch die BlueXP Kopier- und Synchronisierungsfunktion wird die neue Synchronisierungsbeziehung erstellt. Klicken Sie anschließend auf *Anzeigen in Dashboard*, um Details zur neuen Beziehung anzuzeigen.
